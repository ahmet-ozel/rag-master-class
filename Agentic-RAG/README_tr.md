...
### ADIM 1: Orkestratör (Ana Kod / Trafik Polisi)
...
- ** Bulut (Veri dışarı çıkabiliyorsa):** Claude 3.5 Sonnet veya GPT-4o (Araç seçmede, planlamada dünyanın en zeki modelleri).
- ** Yerel (Veri şirket içinde kalacaksa):** vLLM veya Ollama üzerinde koşan Qwen-2.5-32B/72B-Instruct veya Llama-3.3-70B.
